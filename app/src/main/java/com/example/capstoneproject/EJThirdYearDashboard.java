...
public class EJThirdYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejthird_year_dashboard);
        ...
        getSupportActionBar().setTitle("EJ Third Year Dashboard");

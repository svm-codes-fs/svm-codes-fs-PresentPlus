...
public class METhirdYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_methird_year_dashboard);
        ...
        getSupportActionBar().setTitle("ME Third Year Dashboard");

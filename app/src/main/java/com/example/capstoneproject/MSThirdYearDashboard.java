...
public class MSThirdYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msthird_year_dashboard);
        ...
        getSupportActionBar().setTitle("MS Third Year Dashboard");

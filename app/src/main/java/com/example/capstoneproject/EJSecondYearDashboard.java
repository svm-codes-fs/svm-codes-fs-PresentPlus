...
public class EJSecondYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejsecond_year_dashboard);
        ...
        getSupportActionBar().setTitle("EJ Second Year Dashboard");

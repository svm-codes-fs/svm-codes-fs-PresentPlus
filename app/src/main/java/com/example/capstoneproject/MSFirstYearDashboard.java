...
public class MSFirstYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msfirst_year_dashboard);
        ...
        getSupportActionBar().setTitle("MS First Year Dashboard");

...
public class COFirstYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cofirst_year_dashboard);
        ...
        getSupportActionBar().setTitle("CO First Year Dashboard");

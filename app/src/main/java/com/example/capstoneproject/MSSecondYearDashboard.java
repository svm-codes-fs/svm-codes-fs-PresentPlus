...
public class MSSecondYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mssecond_year_dashboard);
        ...
        getSupportActionBar().setTitle("MS Second Year Dashboard");

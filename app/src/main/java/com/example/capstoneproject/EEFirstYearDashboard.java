...
public class EEFirstYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eefirst_year_dashboard);
        ...
        getSupportActionBar().setTitle("EE First Year Dashboard");

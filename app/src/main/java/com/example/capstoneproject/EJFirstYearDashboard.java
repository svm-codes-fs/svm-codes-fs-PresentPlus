...
public class EJFirstYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejfirst_year_dashboard);
        ...
        getSupportActionBar().setTitle("EJ First Year Dashboard");

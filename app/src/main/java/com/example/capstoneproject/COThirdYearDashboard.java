...
public class COThirdYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cothird_year_dashboard);
        ...
        getSupportActionBar().setTitle("CO Third Year Dashboard");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            startActivity(new Intent(this, AppPrivacyAndPolicy.class));

        } else if (id == R.id.nav_terms) {
            Toast.makeText(this, "Terms & Conditions clicked", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(this, AppTermsActivity.class));


        } else if (id == R.id.nav_about) {
            Toast.makeText(this, "About App clicked", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(this, AppAboutUsAAUActivity.class));

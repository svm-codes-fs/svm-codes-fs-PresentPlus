...
public class MEFirstYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mefirst_year_dashboard);
        ...
        getSupportActionBar().setTitle("ME First Year Dashboard");

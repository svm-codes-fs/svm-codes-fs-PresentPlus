...
public class EESecondYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eesecond_year_dashboard);
        ...
        getSupportActionBar().setTitle("EE Second Year Dashboard");

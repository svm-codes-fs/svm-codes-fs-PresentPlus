...
public class COSecondYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cosecond_year_dashboard);
        ...
        getSupportActionBar().setTitle("CO Second Year Dashboard");

...
public class CESecondYearDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cesecond_year_dashboard);
        ...
        getSupportActionBar().setTitle("CE Second Year Dashboard");
